...
static char *tagsel[][2] = {
  ...
  { normbgcolor, selbgcolor  }, /* sel */
  { selbgcolor,  normbgcolor }, /* occ but not sel */
  { normbgcolor, selbgcolor}, /* has pinned tag */
};
/* tagging */
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", selbgcolor, "-sb", selbordercolor, "-sf", selfgcolor, NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_d,			 setgaps,        {.i = -1 } },
